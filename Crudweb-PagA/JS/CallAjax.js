...
function ActualizarDatos() {
    ...
    if(vnombre == "" || vapellido == "" || vmensaje == ""){
        ...
        fetch('PHP/ACTU.php?id=' + document.getElementById("txtIDU").value + '&nombre=' + vnombre + '&apellido=' + vapellido + '&mensaje=' + vmensaje)
...
function Eli_data() {
    ...
    fetch('PHP/El_data.php?id=' +  document.getElementById("txtIDU").value)
